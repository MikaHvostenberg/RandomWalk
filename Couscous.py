...
cwd = os.getcwd()
data = pd.read_csv(cwd + '/RandomWalk/Couscous.csv',delimiter = ',')
...
fig.savefig('timedevelop.pdf')

figa,axsa=plt.subplots(6,figsize=(8,10),constrained_layout=True,sharex=True)
